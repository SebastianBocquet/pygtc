...
and not Gaussian 1, 2, and 3 sigma levels. Your posterior distributions will in
general not be Gaussian, and so we argue that there is no "right" choice. We
therefore recommend that you stick to the definition that is
commonly used in your field, and clearly mention what quantities you are showing
in your figure caption. You can switch to displaying Gaussian sigma levels
(in two dimensions, these correspond to the 39%, 86%, and 99% confidence levels)
